            ...
            <nav className={`fixed w-full top-0 left-0 z-50 transition-all duration-300 ${
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <Link to="https://wa.link/09sns7" target="_blank" rel="noopener noreferrer" className="bg-highlight hover:bg-highlight-600 text-white px-4 py-2 rounded-md text-sm font-medium shadow-md">
                            Probar Gratis
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center md:hidden">
                        <Link to="https://wa.link/09sns7" target="_blank" rel="noopener noreferrer" className="mr-4 max-[370px]:mr-1 bg-highlight hover:bg-highlight-600 text-white px-3 py-2 rounded-md text-sm font-medium shadow-md max-[370px]:text-xs max-[370px]:px-2">
                            Probar Gratis
                        </Link>
                        <button 
