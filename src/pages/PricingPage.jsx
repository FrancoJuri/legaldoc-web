  ...
  return (
    <div className="container mx-auto px-4 py-16 mt-10">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4 text-gray-900">Planes</h1>
        <p className="text-gray-600">
          Precios simples y transparentes. Para contratar un plan, hablanos por WhatsApp.
        </p>
      </div>
      ...
      <PricingCard
          ...
          buttonText="Contratar por WhatsApp"
          isAnnual={isAnnual}
        />
